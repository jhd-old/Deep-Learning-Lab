...
segments_fz_50 = felzenszwalb(img, scale=50, sigma=1.0, min_size=50)
segments_fz_100 = felzenszwalb(img, scale=100, sigma=1.0, min_size=50)
segments_fz_150 = felzenszwalb(img, scale=150, sigma=1.0, min_size=50)
segments_fz_200 = felzenszwalb(img, scale=200, sigma=1.0, min_size=50)

fig, ax = plt.subplots(2, 2, figsize=(10, 10), sharex=True, sharey=True)

ax[0, 0].imshow(mark_boundaries(img, segments_fz_50))
ax[0, 0].set_title("Scale 50")
ax[0, 1].imshow(mark_boundaries(img, segments_fz_100))
ax[0, 1].set_title("Scale 100")
